            ...
            <table class="evac-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($citizen->verification_status !== 'verified')
                                <form action="{{ route('citizen-verification.approve', $citizen) }}" method="POST" style="display:inline;">
                                    @csrf
                    ...
                    <div class="modal fade" id="rejectModal{{ $citizen->id }}" tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content" style="border-radius:14px;border:none;">
                                <form action="{{ route('citizen-verification.reject', $citizen) }}" method="POST">
                                    @csrf
                                    <div class="modal-header border-0 pb-0">
