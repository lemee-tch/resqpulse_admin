...
<head>
    ...
    <title>RESQPULSE – Critical</title>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ── TABLE (same visual language as the Incidents page) ── */
        .table-card { background: #fff; border-radius: 14px; border: 1px solid #e5e7eb; overflow: hidden; }
        .critical-table { width: 100%; border-collapse: collapse; }
        .critical-table thead tr { background: #f9fafb; border-bottom: 1px solid #e5e7eb; }
        .critical-table th { padding: 14px 18px; font-size: .78rem; font-weight: 700; color: #374151; text-align: left; white-space: nowrap; letter-spacing: .3px; }
        .critical-table tbody tr.critical-row { border-bottom: 1px solid #f3f4f6; transition: background .15s; cursor: pointer; }
        .critical-table tbody tr.critical-row:last-child { border-bottom: none; }
        .critical-table tbody tr.critical-row:hover { background: #fef2f2; }
        .critical-table td { padding: 14px 18px; font-size: .82rem; color: #4b5563; vertical-align: middle; }
        ...
        .empty-state i { font-size: 2.2rem; color: #34d399; margin-bottom: 10px; display: block; }
    </style>
</head>
<body>
...
<div class="main-wrap">
    <div class="content">
        ...
        <div class="page-header">
            <div class="page-title"><i class="bi bi-exclamation-triangle-fill" style="color:#dc2626;"></i> Critical</div>
            <a href="{{ route('dashboard') }}" class="back-link"><i class="bi bi-arrow-left"></i> Back to Dashboard</a>
        </div>
        <div class="page-sub">
            Every critical-priority, unresolved report — regular incidents and SOS alerts together, since an SOS is always critical by definition.
        </div>
        ...
        <div class="table-card">
            @if($criticalIncidents->isEmpty())
                <div class="empty-state">
                    ...
                    Nothing critical and unresolved right now.
                </div>
            @else
